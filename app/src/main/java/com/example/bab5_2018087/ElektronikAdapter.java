...
public class ElektronikAdapter extends RecyclerView.Adapter<ElektronikAdapter.MakananViewHolder> {
    String data1[], data2[], data3[];
    int images[];
    Context context;
    public ElektronikAdapter(Context ct, String s1[], String s2[], String s3[], int  img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
        data3 = s3;
    ...
    onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.item_elektronik, parent, false);
